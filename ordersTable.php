...
?>
	...
	<div class="module">
							...
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%" style="font-size: 11px;">
									<thead>
										<tr>
											<th>Full Name</th>
									...
									var startdate=document.getElementById('datepicker-10').value
									var enddate=document.getElementById('datepicker-1').value
